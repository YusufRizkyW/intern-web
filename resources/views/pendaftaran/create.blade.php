                    ...
                    <form action="{{ route('pendaftaran.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                Silahkan upload dokumen (surat pengantar) dan salin link folder Google Drive yang berisi dokumen peserta, 
                                pastikan pengaturan link dapat diakses oleh siapa saja yang memiliki link.
                            </p>
                        </div>
